...
-- enabling python3 provider 
-- vim.g.python3_host_prog = vim.fn.exepath 'C:/Python39/python.exe'
vim.g.python3_host_prog = vim.fn.exepath 'C:/Program Files/WindowsApps/PythonSoftwareFoundation.Python.3.12_3.12.2032.0_x64__qbz5n2kfra8p0/python3.12.exe'
